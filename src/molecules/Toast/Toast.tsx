...
const variantStyles: Record<ToastVariant, string[]> = {
  ...
  success: [
    'border-[var(--color-periwinkle)]/30',
  ],
  error: [
    'border-[var(--color-pink)]/30',
  ],
  warning: [
    'border-[var(--color-green)]/30',
  ],
  info: [
    'border-[var(--color-indigo)]/30',
  ],
}

const variantIconColors: Record<ToastVariant, string> = {
  default: 'text-[var(--color-grey-400)]',
  success: 'text-[var(--color-periwinkle)]',
  error: 'text-[var(--color-pink)]',
  warning: 'text-[var(--color-green)]',
