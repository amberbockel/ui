      ...
      return (
        <div className="min-h-[400px] flex items-center justify-center p-8">
          <div className="text-center max-w-md">
            <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[var(--color-pink)]/10 flex items-center justify-center">
              <svg
...
export function ErrorFallback({
  ...
  return (
    ...
    >
      <div className="text-center max-w-md">
        <div className="w-20 h-20 mx-auto mb-8 rounded-full bg-[var(--color-pink)]/10 flex items-center justify-center">
          <svg
            className="w-10 h-10 text-[var(--color-pink)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
